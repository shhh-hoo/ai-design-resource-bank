...
- use original mnemonic diagrams on the public Dictionary surface unless source reuse is clearly permitted;
...
`term → mnemonic → recognition → example → related vocabulary → selection`
...
- each live demo or mnemonic should teach one concept clearly;
