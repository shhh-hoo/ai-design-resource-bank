...
Web and machine retrieval are actor-neutral and can independently discover/compare candidates in parallel. Default navigation: **Atlas | Explore | Dictionary | Index**. The Human Atlas defaults to the cross-media Creative World, grouped as an editorial browsing surface for visual recognition and comparison. Academic Subject Packs remain available through subject → canonical knowledge point → concrete examples without becoming the Human taxonomy. Explore discovers Examples through search plus secondary refinement by world, creative domain, Concept, medium, interaction, visual trait, Resource availability and coverage kind. Dictionary explains a Concept through real Examples and then exposes related Concepts plus Resource/Tool implementation paths. Index is the exhaustive compact entity browser. No curriculum-board navigation.
